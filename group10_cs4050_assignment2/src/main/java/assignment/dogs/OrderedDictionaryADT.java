...
public interface OrderedDictionaryADT {
 ...
 /* Returns the Record object with key k, or It throws a DictionaryException
     ...
     */
    public DogRecord find(DataKey k) throws assignment.dogs.DictionaryException;
    ...
    /* Returns the record with smallest key in the ordered dictionary. 
       ...
       @throws assignment.dogs.DictionaryException
     */
    public DogRecord smallest() throws assignment.dogs.DictionaryException;
    ...
    /* Returns the record with largest key in the ordered dictionary. 
       ...
       @throws assignment.dogs.DictionaryException
     */
    public DogRecord largest() throws assignment.dogs.DictionaryException;
